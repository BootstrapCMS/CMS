    ...
    <div class="span12">
        ...
        <div class="span6">
            <div class="pull-right">
                <a class="btn btn-success" href="{{ URL::route('pages.show', $page->slug) }}">Show Page</a> <a class="btn btn-danger action_confirm" href="{{ URL::route('pages.destroy', $page->slug) }}" data-token="{{ Session::getToken() }}" data-method="DELETE">Delete Page</a>
            </div>
        </div>
<hr>
