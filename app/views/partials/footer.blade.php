        ...
        <div class="row">
            <div class="col-xs-8">
                <p class="text-muted credit">
                    © <a href="https://github.com/GrahamCampbell">{{{ Config::get('platform.author') }}}</a> 2015. All rights reserved.
                </p>
            </div>
            <div class="col-xs-4">
...
{{ HTML::script('//cdnjs.cloudflare.com/ajax/libs/jquery-timeago/1.4.0/jquery.timeago.min.js') }}
